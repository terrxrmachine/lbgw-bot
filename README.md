...
- **Публикация в канал**: одобренные отзывы автоматически публикуются в канал отзывов
...
1. Используйте существующий бот с токеном `7616206547:AAGZX9Uu4As9UdM3Lth2dVE7J-cfMaffvS4`
2. Добавьте бота в группу/чат с ID `6626945924`
3. (Опционально) Создайте канал для публикации отзывов и добавьте бота как администратора
...
### `/stats [период]`
Получение статистики сайта за указанный период.
